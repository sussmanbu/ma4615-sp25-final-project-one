...
2. boom: cCnverts statistical model objects into tidy data frames, making it easier to summarize, visualize, and report model results using the tidyverse workflow.
