...
## 4.3 Multiple Regression: Comprehensive Model
...
## 4.4 Multiple Regression with Interaction Term
...
### 5. Reflection on Data and Big Picture Alignment
...
While the results are insightful, several limitations should be noted:

- **Observational Data:** Causal inference cannot be definitively claimed; unobserved confounders may influence results.
- **Data Period:** The analysis covers 2006–2013; more recent trends are not captured.
- **Omitted Variables:** Factors such as school leadership quality, curriculum rigor, or community support are not included.
- **Simplified Racial Categorization:** Majority race grouping may oversimplify the diversity within districts.

Future research could expand with more granular, longitudinal, and qualitative data.


### 7 Conclusion


This project underscores that graduation outcomes are not determined by funding levels alone. 
Instead, they reflect the intertwined effects of **economic disadvantage**, **racial composition**, and **structural resource disparities**.

Our best-performing model — multiple regression with an interaction term — highlights that the benefit of educational investment depends critically on the existing social and economic context.

Meaningful educational equity efforts must therefore **combine adequate funding with targeted interventions** that address the broader social determinants of student success.
